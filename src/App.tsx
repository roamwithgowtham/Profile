...
import { adventures, interests, profile } from "./data";
        ...
        <section id="about" className="about-section">
          <div className="container about-grid">
            ...
            <div className="about-copy">
              ...
              <p>
                Football right-back. Endurance cyclist. Runner. And the creator
                behind RoamwithGowtham — sharing rides, travel, and everyday
                moments, with a future triathlon goal on the horizon.
              </p>
              <p>
